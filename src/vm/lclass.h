...
#ifndef LUAUC_LCLASS_H
#define LUAUC_LCLASS_H
 ...
 */
LUAI_FUNC luauc_class_t* luaR_newclass(
    lua_State* L,
    tstring_t* name,
 ...
 */
LUAI_FUNC void luaR_addclassmember(lua_State* L, luauc_class_t* classobject, tstring_t* name, tvalue_t* method);

LUAI_FUNC void luaR_freeclass(lua_State* L, luauc_class_t* classobject, lua_page_t* page);
