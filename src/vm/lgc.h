...
LUAI_FUNC void luaC_initobj(lua_State* L, gc_object_t* o, uint8_t tt);
LUAI_FUNC void luaC_upvalclosed(lua_State* L, upvalue_t* uv);
LUAI_FUNC void luaC_barrierf(lua_State* L, gc_object_t* o, gc_object_t* v);
LUAI_FUNC void luaC_barriertable(lua_State* L, lua_table_t* t, gc_object_t* v);
LUAI_FUNC void luaC_barrierback(lua_State* L, gc_object_t* o, gc_object_t** gclist);
