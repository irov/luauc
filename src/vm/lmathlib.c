...
static uint32_t __pcg32_random(uint64_t* state)
{
...
static void __pcg32_seed(uint64_t* state, uint64_t seed)
{
    *state = 0;
    __pcg32_random(state);
    *state += seed;
    __pcg32_random(state);
}

static int __math_abs(lua_State* L)
{
    lua_pushnumber(L, fabs(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_sin(lua_State* L)
{
    lua_pushnumber(L, sin(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_sinh(lua_State* L)
{
    lua_pushnumber(L, sinh(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_cos(lua_State* L)
{
    lua_pushnumber(L, cos(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_cosh(lua_State* L)
{
    lua_pushnumber(L, cosh(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_tan(lua_State* L)
{
    lua_pushnumber(L, tan(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_tanh(lua_State* L)
{
    lua_pushnumber(L, tanh(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_asin(lua_State* L)
{
    lua_pushnumber(L, asin(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_acos(lua_State* L)
{
    lua_pushnumber(L, acos(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_atan(lua_State* L)
{
    lua_pushnumber(L, atan(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_atan2(lua_State* L)
{
    lua_pushnumber(L, atan2(luaL_checknumber(L, 1), luaL_checknumber(L, 2)));
    return 1;
}

static int __math_ceil(lua_State* L)
{
    lua_pushnumber(L, ceil(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_floor(lua_State* L)
{
    lua_pushnumber(L, floor(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_fmod(lua_State* L)
{
    lua_pushnumber(L, fmod(luaL_checknumber(L, 1), luaL_checknumber(L, 2)));
    return 1;
}

static int __math_modf(lua_State* L)
{
    double ip;
...
static int __math_sqrt(lua_State* L)
{
    lua_pushnumber(L, sqrt(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_pow(lua_State* L)
{
    lua_pushnumber(L, pow(luaL_checknumber(L, 1), luaL_checknumber(L, 2)));
    return 1;
}

static int __math_log(lua_State* L)
{
...
static int __math_log10(lua_State* L)
{
    lua_pushnumber(L, log10(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_exp(lua_State* L)
{
    lua_pushnumber(L, exp(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_deg(lua_State* L)
{
    lua_pushnumber(L, luaL_checknumber(L, 1) / RADIANS_PER_DEGREE);
    return 1;
}

static int __math_rad(lua_State* L)
{
    lua_pushnumber(L, luaL_checknumber(L, 1) * RADIANS_PER_DEGREE);
    return 1;
}

static int __math_frexp(lua_State* L)
{
    int e;
...
static int __math_ldexp(lua_State* L)
{
    lua_pushnumber(L, ldexp(luaL_checknumber(L, 1), luaL_checkinteger(L, 2)));
    return 1;
}

static int __math_min(lua_State* L)
{
...
static int __math_max(lua_State* L)
{
    int n = lua_gettop(L); // number of arguments
...
static int __math_random(lua_State* L)
{
    ...
    { // no arguments
        ...
        uint32_t rl = __pcg32_random(&g->rngstate);
        uint32_t rh = __pcg32_random(&g->rngstate);
    ...
    { // only upper limit
        ...
        uint64_t x = (uint64_t)(u) * __pcg32_random(&g->rngstate);
        int r = (int)(1 + (x >> 32));
    ...
    { // lower and upper limits
        ...
        uint64_t x = (uint64_t)(ul + 1) * __pcg32_random(&g->rngstate);
        int r = (int)(l + (x >> 32));
...
static int __math_randomseed(lua_State* L)
{
    int seed = luaL_checkinteger(L, 1);

    __pcg32_seed(&L->global->rngstate, seed);
    return 0;
}

static const unsigned char __kPerlinHash[257] = {
...
static inline float __perlin_fade(float t)
{
    return t * t * t * (t * (t * 6 - 15) + 10);
}

static inline float __perlin_lerp(float t, float a, float b)
{
    return a + t * (b - a);
}

static inline float __perlin_grad(int hash, float x, float y, float z)
{
    const float* g = kPerlinGrad[hash & 15];
    return g[0] * x + g[1] * y + g[2] * z;
}

static float __perlin(float x, float y, float z)
{
    float xflr = floorf(x);
    float yflr = floorf(y);
    float zflr = floorf(z);
    ...
    float u = __perlin_fade(xf);
    float v = __perlin_fade(yf);
    float w = __perlin_fade(zf);

    const unsigned char* p = __kPerlinHash;
    ...
    float la = __perlin_lerp(u, __perlin_grad(p[aa], xf, yf, zf), __perlin_grad(p[ba], xf - 1, yf, zf));
    float lb = __perlin_lerp(u, __perlin_grad(p[ab], xf, yf - 1, zf), __perlin_grad(p[bb], xf - 1, yf - 1, zf));
    float la1 = __perlin_lerp(u, __perlin_grad(p[aa + 1], xf, yf, zf - 1), __perlin_grad(p[ba + 1], xf - 1, yf, zf - 1));
    float lb1 = __perlin_lerp(u, __perlin_grad(p[ab + 1], xf, yf - 1, zf - 1), __perlin_grad(p[bb + 1], xf - 1, yf - 1, zf - 1));

    return __perlin_lerp(w, __perlin_lerp(v, la, lb), __perlin_lerp(v, la1, lb1));
}

static int __math_noise(lua_State* L)
{
    int nx, ny, nz;
    ...
    if (FFlag_FixMathNoisePrecision)
    {
    ...
    double r = __perlin((float)x, (float)y, (float)z);

    lua_pushnumber(L, r);
    return 1;
}

static int __math_clamp(lua_State* L)
{
...
static int __math_sign(lua_State* L)
{
    double v = luaL_checknumber(L, 1);
...
static int __math_round(lua_State* L)
{
    lua_pushnumber(L, round(luaL_checknumber(L, 1)));
    return 1;
}

static int __math_map(lua_State* L)
{
    double x = luaL_checknumber(L, 1);
...
static int __math_lerp(lua_State* L)
{
...
static int __math_isnan(lua_State* L)
{
    double x = luaL_checknumber(L, 1);
...
static int __math_isinf(lua_State* L)
{
    double x = luaL_checknumber(L, 1);
...
static int __math_isfinite(lua_State* L)
{
    double x = luaL_checknumber(L, 1);
...
static const luaL_Reg __mathlib[] = {
    {"abs", __math_abs},
    {"acos", __math_acos},
    {"asin", __math_asin},
    {"atan2", __math_atan2},
    ...
    {"pow", __math_pow},
    {"rad", __math_rad},
    {"random", __math_random},
    {"randomseed", __math_randomseed},
    {"sinh", __math_sinh},
    {"sin", __math_sin},
    {"sqrt", __math_sqrt},
    {"tanh", __math_tanh},
...
int luaopen_math(lua_State* L)
{
    ...
    luaL_register(L, LUA_MATHLIBNAME, __mathlib);
